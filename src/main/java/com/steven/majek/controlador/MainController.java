...
//
//import com.steven.majek.entities.*;
...
//        categoriaRopa.setTipoCategoria("Mujer");
//
//        categoriaHogar = new Categoria();
//        categoriaHogar.setTipoCategoria("Hombre");
//
//        categoriatecno = new Categoria();
//        categoriatecno.setTipoCategoria("Niños");
//
//        categoriaOtros = new Categoria();
//        categoriaOtros.setTipoCategoria("Hogar");
//
